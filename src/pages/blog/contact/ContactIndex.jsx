    ...
    <div className="b-contact-wrapper">
      ...
      >
        <div className="b-contact-content-hero-infos-container">
          ...
          <p id="b-contact-content-paragraph">
            Une demande, une information ? Remplissez le formulaire ci dessous.
          </p>
        </div>
      </div>
        ...
        <div className="b-contact-content-container">
          <div className="b-contact-content-left">
            <form onSubmit={(e) => handleSubmit(e)}>
              ...
              <div
                className="b-contact-input-default"
                ref={inputTextareaElemRef}
              >
                <textarea
              ...
              <div
                className="b-contact-input-checkbox"
                ref={inputCheckboxElemRef}
              >
                <div className="b-contact-input-center">
                  <input
                    id="b-contact-input-checkbox-item"
                    type="checkbox"
                ...
                <label id="label-checkbox">
                  ...
                  saisies soient utilisées afin de me permettre de vous
                  recontacter.
                </label>
              </div>
          ...
          <div className="b-contact-content-right">
            ...
            <div className="b-contact-info">
              <AiOutlineMail style={btnStyle} />{" "}
              <p>gaelle-boucherit@gmail.com</p>
            </div>
