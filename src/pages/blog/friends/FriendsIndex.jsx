...
const FriendsIndex = () => {
  ...
  return (
    <div className="b-friends-wrapper">
      {cookieIsAuth ? (
        <div
          className="bp-left-bar-trigger-btn"
      ...
      <LeftBar
        ...
        leftBarElemRef={leftBarElemRef}
        closeLeftBar={closeLeftBar}
        openCreateFriendModal={openCreateFriendModal}
      />
      <Loader loaderElem={loaderElem} />
      <CreateFriend
        createFriendModalRef={createFriendModalRef}
        setIsLoading={setIsLoading}
      />
      <DeleteFriend
        deleteFriendModalRef={deleteFriendModalRef}
        setIsLoading={setIsLoading}
        friends={friends}
      />

      <div
        className="b-friends-hero"
        style={{
      ...
      >
        <div className="b-friends-content-hero-infos-container">
          ...
          <p id="b-friends-content-paragraph">
            Ici vous pourrez trouver tous les sites des personnes que j'apprécie
            le plus.
          </p>
        </div>
      </div>
        ...
        <div className="b-friends-list-wrapper">
          {friends.map((friend) => (
            <div className="b-friends-single-friend-container">
              <div
                className="bp-link-preview-wrapper"
                onClick={() => openPage(friend.url)}
              >
                {friend.image !== "no img" ? (
