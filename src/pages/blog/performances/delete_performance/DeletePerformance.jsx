...
const DeletePerformance = (props) => {
  ...
  return (
    <div
      className="bp-perf-delete-performances-wrapper"
      ref={props.deletePerformancesModalRef}
    >
      ...
      <form
        id="bp-perf-delete-perf-form"
        onSubmit={(e) => tryToDestroyPerformance(e)}
      >
        <select id="remove-perf-select">
          {props.value &&
            props.value.map((perf) => (
              <>
