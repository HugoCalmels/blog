    ...
    <div className="bp-perf-content-wrapper">
      <div className="bp-perf-content">
          ...
          {props.selectedValue.featuring.length > 0 ? (
            <h5>
              ...
              {props.selectedValue.website_link && errorMessage.length === 0 ? (
                <a
                  target="_blank"
                  href={props.selectedValue.website_link}
                  id="bp-perf-content-feat-link"
                >
                  {props.selectedValue.featuring}
                </a>
              ) : (
        ...
        <video
          id="bp-video-player"
          controls
          src={props.selectedValue.video_url}
          max-width="100%"
          height="auto"
        />
        ...
        {linkPreview.error || props.selectedValue.website_link.length === 0 ? (
          ...
          <>
            ...
            <h3 id="bp-perf-more-websites-title">
              Retrouvez {props.selectedValue.featuring} sur son site
            </h3>

            <div
              className="bp-link-preview-wrapper-perf"
              onClick={() => openPage(linkPreview.url)}
            >
              {linkPreview.images && linkPreview.images.length > 0 ? (
                <img src={linkPreview.images[0].src} />
              ) : (
                <div className="bp-content-no-photo"></div>
              )}
