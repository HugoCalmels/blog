...
const CreatePerformance = (props) => {
  ...
  const createExtraPerformanceVideoAPI = async (
    extraTitle,
    file,
    performanceID
  ) => {
    ...
    const extraVideoResponse = await fetch(
      `${BASE_URL}/api/v1/performances/${performanceID}/extra_performance_videos`,
      config
    );
  ...
  return (
    <div
      className="bp-create-performance-modal"
      ref={props.performanceModalRef}
    >
      ...
      <form onSubmit={(e) => handleSubmit(e)}>
        ...
        <div className="bp-create-perf-input">
          ...
          <textarea
            className="bp-input-text textarea"
            type="text"
