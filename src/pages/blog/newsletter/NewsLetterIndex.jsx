...
const NewsLetterIndex = (props) => {
  ...
  return (
    <div className="b-newsletter-wrapper">
      ...
      <div className="b-newsletter-hero"style={{ 
...
<h2 id="b-newsletter-content-title">NEWSLETTER</h2>
          ...
          <p id="b-newsletter-subscribe-infos">Pour vous abonner à notre newsletter, merci de remplir le formulaire ci dessous.</p>
          <form id="b-newsletter-join-form"onSubmit={(e) => handleSubmit(e)}>
          
            
            <input id="b-newsletter-input-email" type="text" placeholder="E-mail" onChange={(e) => setEmail(e.target.value)}></input>
          
            <div className="b-newsletter-input-checkbox-container">
              <div className="b-newsletter-checkbox-wrapper">
              <input id="b-newsletter-input-checkbox"type="checkbox" onChange={() => setChecked(!checked)}></input>
              </div>
                <label id="b-newsletter-label-rgpd">En soumettant ce formulaire, vous acceptez nos <span onClick={()=>props.openPolicyModal()}>conditions générales d'utilisation</span>. </label>
            </div>
