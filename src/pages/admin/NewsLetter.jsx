      ...
      {cookieIsAuth ? (
        <>
          <div className="admin-newsletter-paragraph">
            ...
            <p>
              1. Aller sur{" "}
              <a href="https://stripo.email/fr/" target="_blank">
                https://stripo.email/fr/
              </a>{" "}
              pour créer son template
            </p>
            ...
            <p>
              6. Pour finir cliquer sur "HTML", ensuite "Code HTML", et pour
              finir cliquer sur "Copier dans le presse-papiers".
            </p>
            <p>
              7. Une fois le code copié, il faut le coller dans la zone de texte
              ci dessous.
            </p>
          </div>

          <form
            className="admin-newsletter-input-form"
            onSubmit={(e) => handleSubmitNewsLetter(e)}
          >
            <textarea
              placeholder="Insérer le code HTML du template d'email ici."
              onChange={(e) => setTemplateEmail(e.target.value)}
            ></textarea>
            <div
              className="b-admin-template-email-preview-container"
              ref={templateEmailPreviewElemRef}
            ></div>
            <input
              disabled={!canSave}
              className="admin-newsletter-send-input"
              type="submit"
              value="Envoyer newsletter"
              ref={btnSend}
            ></input>
          </form>
        </>
