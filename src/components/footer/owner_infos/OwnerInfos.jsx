...
const OwnerInfos = () => {
  const styleRegularIcons = { width: "15px", height: "15px", marginRight: "5px"}
  const styleSocialNetworkIcons = { color: "black", width: "15px", height: "15px"}
  return (
    ...
    <li className="b-footer-owner-info location">
      ...
      <Link to={"/gaelle-boucherit"}>13, rue Pégot <br/>31500 Toulouse</Link>
    </li>
