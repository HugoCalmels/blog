...
import plusSquaredIcon from "../../../assets/icons/plusSquaredIcon2.png"
...
const NavbarHomeButton = (props) => {
  ...
  const openModal = () => {
    ...
    indexListModalElem.current.style.transform = "translateY(0px)"
    plusElem.current.style.transform = "rotate(360deg)"
  }
  const closeModal = () => {
    //indexListModalElem.current.classList.remove("active")
    indexListModalElem.current.style.transform = "translateY(-100px)"
  ...
  if (props.pathname === "/gaelle-boucherit" && linebarSelectedOptionRef.current) {
  ...
  return (
    <div className="b-navbar-home-button-wrapper">
      ...
      <div className="b-navbar-option-btn-container-index" onMouseEnter={(e)=>selectMenu(e, "index", true)} onMouseLeave={(e)=>selectMenu(e, "index", false)} onClick={()=>navigateTo("gaelle-boucherit")}>
        <div className="b-navbar-option__btn">
        <span className="b-navbar-option__btn__first-span">GAËLLE BOUCHERIT</span>
