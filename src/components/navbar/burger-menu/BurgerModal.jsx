  ...
  return (
    <div className="b-navbar-burger-modal-container" ref={props.burgerModalElem}>
      <ul className="b-navbar-burger-modal-ul">
        ...
        <li onClick={()=>navigateTo("gaelle-boucherit/dessins-et-croquis")}>DESSINS</li>
        <li onClick={()=>navigateTo("gaelle-boucherit/photos")}>PHOTOS</li>
        <li onClick={()=>navigateTo("gaelle-boucherit/performances")}>PERFORMANCES</li>
        <li onClick={()=>navigateTo("gaelle-boucherit/coups-de-coeur")}>COUPS DE COEUR</li>
        <li onClick={()=>navigateTo("gaelle-boucherit/contact")}>CONTACT</li>
        <li onClick={()=>navigateTo("gaelle-boucherit/newsletter")}>NEWSLETTER</li>
      </ul>
    </div>
  )
}
